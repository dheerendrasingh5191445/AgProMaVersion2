...
namespace UnitTestingAgProMa.Services
{
   public class BacklogServiceTest
    {
        [Fact]
        public void Backlog_Service_GetAll_Method_To_GetAll_Request_Should_Be_NotNull()
        {
            //Arrange
        ...
        [Fact]
        public void Backlog_Service_GetAll_Method_To_GetAll_Request_Should_Compare_Values()
        {
            //Arrange
            List<UserStory> requests = new List<UserStory>();
            var request = new UserStory();
        ...
        [Fact]
        public void Backlog_Service_Update_Method_To_Update_userStory_Should_Be_NotNull()
        {
            //Arrange
            List<UserStory> requests = new List<UserStory>();
            var request = new UserStory();
        ...
        [Fact]
        public void Backlog_Service_Update_Method_To_Update_userStory_Should_Compare_Values()
        {
            //Arrange
            List<UserStory> requests = new List<UserStory>();
            var request = new UserStory();
        ...
        [Fact]
        public void Backlog_Service_Update_Method_To_Update_userStory_Should_Be_Of_UserStory_type()
        {
            //Arrange
            List<UserStory> requests = new List<UserStory>();
            var request = new UserStory();
        ...
        [Fact]
        public void Backlog_Service_JoinGroup_Method_Should_Be_NotNull()
        {
            //Arrange
        ...
        [Fact]
        public void Backlog_Service_JoinGroup_Method_Should_Compare_Values()
        {
            //Arrange
            List<SignalRMaster> requests = new List<SignalRMaster>();
            var request = new SignalRMaster();
